" startting point for a qpascal syntax file
" Vim syntax file
" Language:	Pascal
" Version: 2.8
...
" QPascal types
syn keyword pascalType	counter quad tString
syn keyword pascalType	pInteger pWord pCounter pQuad pBoolean pString
syn keyword pascalType	tFunctionReference

" QPascal built in functions
syn keyword pascalFunction LowerCase DecLength RightCopy RightDelete RightPos
syn keyword pascalFunction SetLength SetStringElement UpperCase
syn keyword pascalFunction Cast TruncToCounter
syn keyword pascalFunction ByteFill CharFill CharScanBackUntil CharScanBackWhile
syn keyword pascalFunction CharScanUntil CharScanWhile FunctionFrame FunctionOffset FunctionSegment
syn keyword pascalFunction Mark Release ScanBackUntil ScanBackWhile ScanUntil ScanWhile
syn keyword pascalFunction VarDispose VarNew WordSizeOf ZeroFill

" QPascal constants
syn keyword pascalConstant	minByte maxByte minInt minWord maxWord
syn keyword pascalConstant	minCounter maxCounter minQuad maxQuad
...
" vim: ts=8 sw=2
"
" suggested off the cuff folding scheme taken from stack overflow
" http://vi.stackexchange.com/questions/2248/how-to-create-syntax-folding-for-pascal
"

...
" ecstract statements
syn keyword ecStatement	abort allow append archive assert attach
syn keyword ecStatement	banner baseFont box break
syn keyword ecStatement	case chain change clear clearScreen colour column com
syn keyword ecStatement	const continue create createFolder critical custom
syn keyword ecStatement dashboard dataPanel dbFind dbToDelete delete
syn keyword ecStatement	deleteAssociated deleteFile deleteFolder display draw
...
syn match ecVersion	"^; \[Ecstract 3\] *$"
syn match ecBadVersion	"^; \[Ecstract [^3].$"
